    ...
    def __init__(self, **kwargs):
        ...
        if 'hidden_spatial_dims' in hyper_params:
            ...
            for size in hyper_params['hidden_spatial_dims']:
                ...
                self.pooling_ops.append(UnPoolingBlock(hyper_params=hyper_params,
        ...
        for k in range(len(hyper_params['channels'])):
            ...
            current_block = []
            if 'only_use_one_conv_block_at_top' in hyper_params and \
                    hyper_params['only_use_one_conv_block_at_top'] and k == len(hyper_params['channels']) - 1:
            ...
            if k < len(hyper_params['channels']) - 1:
                ...
                if hyper_params['convolutional_downsampling']:
                    current_block.append(PoolingBlock(hyper_params=hyper_params,
